...
router.post('/', [auth,
    ...
    async (req, res) => {
        ...
        if (youtube) profileFields.social.youtute = youtube;
...
router.put('/experience', [auth, [
    ...
    try {
        ...
        console.log(e.message);
        res.status(500).send('Experience server error')

    }
});

// @route   DELETE api/profile/experience/:exp_id
// @desc    Delete experience from frofile
// @access  Private
...
router.put('/education', [auth, [
    ...
    try {
        ...
        console.log(e.message);
        res.status(500).send('Education server error')
